      ...
      return (
        <div className="min-h-screen bg-zinc-950 flex flex-col items-center justify-center p-4 text-center" role="alert">
          ...
          <p className="text-zinc-400 mb-8 max-w-md">
            ...
            {this.state.error && <span className="block mt-4 text-xs font-mono bg-zinc-900 p-3 rounded text-red-400 text-left overflow-auto max-h-32">{this.state.error.message}</span>}
          </p>
          <button 
